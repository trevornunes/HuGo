...
int osd_gfx_init(void)
{
  ...
  fprintf(stderr,"osd_gfx_init: \n");
  fprintf(stderr,"          option.window_size  = %d\n", option.window_size);
  fprintf(stderr,"      option.want_fullscreen  = %d\n", option.want_fullscreen = 1);
  fprintf(stderr,"    option.fullscreen_height  = %d\n", option.fullscreen_height);
  fprintf(stderr,"    option.fullscreen_width   = %d\n", option.fullscreen_width);
  fprintf(stderr,"option.want_hardware_scaling  = %d\n", option.want_hardware_scaling =1);
  fprintf(stderr,"option.wanted_hardware_format = %d\n", option.wanted_hardware_format);
