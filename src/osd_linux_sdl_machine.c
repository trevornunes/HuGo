...
osd_init_paths(int argc, char* argv[])
{
...
#else
	char *home_path = "/accounts/1000/shared/misc/";
#endif
	...
	if (home_path)
		{			
			...
			fprintf(stderr,"create roms/pce dir\n");
			mkdir("/accounts/1000/shared/misc/roms/pce",0777);
            system("cp /accounts/1000/app/native/sdl-controls.xml /accounts/1000/shared/misc/hugo/sdl-controls_tco.xml");
		}
	else
		{
